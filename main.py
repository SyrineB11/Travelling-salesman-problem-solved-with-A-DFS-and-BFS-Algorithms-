...
class Graph:
    ...
    def connect(self, A, B, distance=1): #A-----B or B-------A same with the distance between A and B
    ...
    while len(open) > 0:
        ...
        for key, value in neighbors.items():
            ...
            if (neighbor in closed):
                continue
            # Calculate cost to goal #HEURISTIC COST TO GOAL
...
def main():
    ...
    path = best_first_search(graph, heuristics, 'A', 'G')
    dis = 0
    for i in path :
